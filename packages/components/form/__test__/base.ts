...
const defSlot = '按钮'
export function comBaseClass(prop?: any, classes: string = 'z-form') {
  comClass(ZForm, classes, { prop, defSlot })
}
...
// }
// export function comBaseStyle(prop?: any, style: string = 'overflow: hidden; flex-grow: 0; flex-basis: auto;') {
