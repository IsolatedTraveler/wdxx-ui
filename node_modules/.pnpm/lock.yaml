...
importers:
  ...
  .:
    specifiers:
      ...
      '@pnpm/types': ^8.9.0
      '@types/node': ^18.11.9
      '@ui/build-utils': workspace:^1.0.0
      '@ui/components': workspace:^1.0.0
      '@ui/hooks': workspace:^1.0.0
      '@ui/styles': workspace:^1.0.0
      '@ui/utils': workspace:^1.0.0
      '@ui/vars': workspace:^1.0.0
      ...
      vue: ^3.2.45
      z-uis: workspace:^0.0.1
    dependencies:
      '@ui/components': link:packages/components
      '@ui/hooks': link:packages/hooks
      '@ui/styles': link:packages/styles
      '@ui/utils': link:packages/utils
      '@ui/vars': link:packages/vars
      vue: 3.2.45
      z-uis: link:packages/z-ui
    devDependencies:
      '@esbuild-kit/cjs-loader': 2.4.0
      '@pnpm/types': 8.9.0
      '@types/node': 18.11.9
      '@ui/build-utils': link:build/utils
      '@vitejs/plugin-vue-jsx': 2.1.1_vue@3.2.45
      '@vue/shared': 3.2.45
      fast-glob: 3.2.12
      gulp: 4.0.2
      jiti: 1.13.0
      ...
      unbuild: 1.0.1
      unplugin-vue-define-options: 0.12.8
      unplugin-vue-macros: 0.16.4_vue@3.2.45
  ...
  example:
    ...
    devDependencies:
      ...
      unplugin-vue-components: 0.22.9
      vite: 3.2.4
      vite-plugin-inspect: 0.7.8_vite@3.2.4
      vite-plugin-mkcert: 1.10.1_vite@3.2.4
...
packages:
  ...
  /@vitejs/plugin-vue/3.2.0_vue@3.2.45:
    resolution: {integrity: sha512-E0tnaL4fr+qkdCNxJ+Xd0yM31UwMkQje76fsDVBBUCoGOUPexu2VDUYHL8P4CwV+zMvWw6nlRw19OnRKmYAJpw==}
    engines: {node: ^14.18.0 || >=16.0.0}
    peerDependencies:
      vite: ^3.0.0
  ...
  /@vue-macros/define-render/0.13.9_vue@3.2.45:
  ...
  /@vue-macros/named-template/0.0.6_vue@3.2.45:
  ...
  /vite-plugin-inspect/0.7.8_vite@3.2.4:
    resolution: {integrity: sha512-LjLcpKOV3CPxCXXZ+jS6H/3xk9c/lcGLnGu9dCj5RU4jCbHg84dqlrS02UekVx9SvZfaitVJZMUHtWtXG4T4JA==}
    engines: {node: '>=14'}
    peerDependencies:
      vite: ^3.1.0
    dependencies:
