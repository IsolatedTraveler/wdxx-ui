...
export function fl_son(data: any, drlx: CwglZddbLx) {
  if (drlx === 'zfb' || drlx === 'wx') {
    ...
    if (/成都地铁运营|成都天府通/.test(str)) {
      ...
      data.fl = '医疗教育'
      return '药品费'
    } else if (/包佬汇|凤凰自选快餐厅|状元水饺|东满福东北酸菜水饺|罗记现卤|过桥米线|开心包点|金牌牛腩把子肉|西楼兰新疆抓饭|^小罗$|小米餐厅|砂锅食堂首航店|藕然间|徐记乐山烧烤|大众点评点餐|叁元老火锅成都武侯立交店|大米先生|廖记重庆老麻抄手|重庆小面王|酒城小笼包|原窝肠旺|宜宾燃面|沙县小吃|猪脚饭|沐小芸乌鸡米|商户_王艳青|牛卜力金牌牛腩把子肉/.test(str)) {
      data.fl = '食品酒水'
